...
import "../CAFCosumableItem.sol";
import "./ICAFItems.sol";

interface ICAFCompanyItems is ICAFItems {
    // ========================== ACTIONS ==========================
    ...
    function isCompany(uint128 _id) external view returns (bool);
    ...
    event MarketCapUpdated(address indexed company, uint128 newMarketCap);

    /// @notice Emitted when the revenue of a company increases.
    event RevenueGenerated(address indexed company, uint128 amount);
