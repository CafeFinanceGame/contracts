...
interface ICAFDecayableItems {
    ...
    /// @notice Get the last decay time
    /// @return The last decay time
    function getLastAutoDecayTime() external view returns (uint256);
    ...
    event AllItemsDecayed(uint256 lastDecayed);
}
